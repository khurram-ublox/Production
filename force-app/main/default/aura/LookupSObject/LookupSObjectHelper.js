...
({
    ...
    doSearch : function(cmp) {
        ...
        //Get the Description fields
 		var descriptionFields = cmp.get('v.descriptionFields');
        // Create an Apex action
        var action = cmp.get('c.lookupSOQL');

        // Mark the action as abortable, this is to prevent multiple events from the keyup executing
        action.setAbortable();

        // Set the parameters
        action.setParams({ "searchString" : searchString, "sObjectAPIName" : sObjectAPIName, "descriptionFields" : descriptionFields});
